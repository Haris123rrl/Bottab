...
require('./Michi.js')
nocache('../Michi.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./index.js')
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
			await XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nYouTube: https://youtube.com/@VynaaChan\n\nGitHub: https://github.com/DGXeon\n\nInstsgram: https://instagram.com/_xwby_?igshid=ZGUzMzM3NWJiOQ==\n\nWhatsApp Pm: wa.me/6282389924037\n\n WhatsApp Gc1: https://chat.whatsapp.com/ICkXMmtEDsCKXF2pifFeeS\n\nWhatsApp Gc2: https://chat.whatsapp.com/ICkXMmtEDsCKXF2pifFeeS\n\nWhatsApp Store: https://shoplinks.to/vyna-store\n\nDonate: https://saweria.co/Vynaabots \n\n\n_*Thanks to*_\n_*Allah SWT*_\n_*Myself*_\n_*Family*_\n_*Friends who helped me assemble this script*_` });
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: VynaChan`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: DGXeon `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @_xwby_ `,'magenta'))
...
require('./Michi')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
